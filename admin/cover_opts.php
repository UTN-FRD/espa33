...
?>
<font class="error">
  <?php echo $loc->getText('admin_settingsUpdated'); ?>
</font>
<?php
}
$form = $opts->getAWS();
    ...
    <tbody>
        <tr>
            <td valign="top" class="noborder">
                <font class="small"><?php echo $loc->getText('adminFormNote'); ?></font>
            </td>
            <td class="noborder">
                <font class="small">
                    <?php echo $loc->getText('adminAWSNote', array('cover_opt_menu' => $navLoc->getText('Cover Lookup Options'))); ?><br>
                </font>
            </td>
        </tr>
    </tbody>
